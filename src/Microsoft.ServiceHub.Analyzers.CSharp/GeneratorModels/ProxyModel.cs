...
internal record ProxyModel : FormattableModel
{
	...
	internal void GenerateSource(SourceProductionContext context, bool isPublic)
	{
		...
		writer.WriteLine($$"""
			{{visibility}} class {{this.Name}}{{this.GenericTypeSuffix}} : global::Microsoft.ServiceHub.Framework.Reflection.ProxyBase
			""");
	...
	private void WriteInterfaceMapping(SourceWriter writer, InterfaceModel iface)
	{
	...
	private void WriteConstructor(SourceWriter writer)
	{
		writer.WriteLine($$"""
			...
			public {{this.Name}}({{this.Interfaces.First().FullName}} inner, in global::Microsoft.ServiceHub.Framework.Reflection.ProxyInputs inputs)
				: base(inner, inputs)
			{
			""");
