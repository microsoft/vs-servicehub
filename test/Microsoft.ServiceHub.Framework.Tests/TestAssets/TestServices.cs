...
internal static class TestServices
{
	...
	internal static readonly ServiceRpcDescriptor Calculator = new ServiceJsonRpcDescriptor(new ServiceMoniker(nameof(Calculator)), clientInterface: null, ServiceJsonRpcDescriptor.Formatters.UTF8SystemTextJson, ServiceJsonRpcDescriptor.MessageDelimiters.HttpLikeHeaders, multiplexingStreamOptions: null);
